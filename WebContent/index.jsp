<!-- <%@page import="com.db.mongodb.CollectionHandler"%> -->
					...
					<div class="form-group row">
						<div style="padding: 0px;" class="col-lg-12 col-xs-12">
							...
							<textarea rows="12" required="true" name="text"
								...
								<% /*try {
									CollectionHandler mConnection = new CollectionHandler("Discourses", "Discourses");
									out.println(mConnection.getFisrtSpeech());
								}catch (Exception e) {}*/
								%> 
								</textarea>
